...
```{r, fig.align='center', out.width="100%", echo = FALSE, fig.alt= "Image collage of 3 photographs showing students in front of their research posters at various symposia"}
...
```{r, fig.align='center', out.width="100%", echo = FALSE, fig.alt= "Image showing 4 examples of headers from C-MOOR associated posters. Each header has the title of the poster in the largest font, the logos of supporting organizations, and the author list. The headers differ in color and overall aesthetic style."}
...
```{r, fig.align='center', out.width="100%", echo = FALSE, fig.alt= "Image showing 2 abstracts from C-MOOR associated posters. One has a header that reads Abstract".}
...
```{r, fig.align='center', out.width="100%", echo = FALSE, fig.alt= "Image showing 2 introductions from past C-MOOR posters. Both contain a header text that reads: Introduction, and both contain figures, one of which contains a figure legend."}
...
```{r, fig.align='center', out.width="100%", echo = FALSE, fig.alt= "Example Introduction from the PacBio Website, including a header that reads Introduction."}
...
```{r, fig.align='center', out.width="100%", echo = FALSE, fig.alt= "Image showing two introductions from previous C-MOOR posters. Each has a header titled Methods and contain figures and tables, with some legends included. The example on the right also contains text in paragraph form."}
...
```{r, fig.align='center', out.width="100%", echo = FALSE, fig.alt= "An image showing 4 example conclusion or discussion sections from prior C-MOOR posters. Some have headers, but the headers differ in style. One header is more descriptive and others just say Discussion. All 4 have text in bullet point form, some with references in them."}
...
```{r, fig.align='center', out.width="100%", echo = FALSE, fig.alt= "An example reference section from a prior C-MOOR poster, with a bolded header that reads References followed by a list of references in a consistent style."}
...
```{r, fig.align='center', out.width="100%", echo = FALSE, fig.alt= "An image of 3 different acknowledgement sections from prior C-MOOR posters. All have a header that reads: Acknowledgements. One contains a grant number and icons from various supporting institutions."}
