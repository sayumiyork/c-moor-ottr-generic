...
```{r, fig.align='center', out.width="100%", echo = FALSE, fig.alt= "The groups page on SciServer, which you can use to confirm your membership and data access privileges"}
ottrpal::include_slide("https://docs.google.com/presentation/d/1dI8-_iVqbkzNMf11M4dK85E8ZW3OyZECs_YwMKw5fhs/edit#slide=id.g3632cdae791_0_255")
```
...
```{r, fig.align='center', out.width="100%", echo = FALSE, fig.alt= "The list of C-MOOR tutorials - yours may be slightly different."}
ottrpal::include_slide("https://docs.google.com/presentation/d/1dI8-_iVqbkzNMf11M4dK85E8ZW3OyZECs_YwMKw5fhs/edit#slide=id.g3632cdae791_0_371")
```
...
```{r, fig.align='center', out.width="100%", echo = FALSE, fig.alt= "The error message you will see if you did not choose the correct options when setting up your container."}
ottrpal::include_slide("https://docs.google.com/presentation/d/1dI8-_iVqbkzNMf11M4dK85E8ZW3OyZECs_YwMKw5fhs/edit#slide=id.g3632cdae791_0_267")
```
...
```{r, fig.align='center', out.width="100%", echo = FALSE, fig.alt= "Deleting a SciServer container."}
ottrpal::include_slide("https://docs.google.com/presentation/d/1dI8-_iVqbkzNMf11M4dK85E8ZW3OyZECs_YwMKw5fhs/edit#slide=id.g3632cdae791_0_375")
```
