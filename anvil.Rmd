...
```{r, fig.align='center', out.width="100%", echo = FALSE, fig.alt= "Title card for sign up for an AnVIL account which notes a prerequisitite: A Google associated email address such as an institutional account that uses Gmail or a personal Gmail"}
ottrpal::include_slide("https://docs.google.com/presentation/d/1uwlG7uaTOnItdpd4Ll6nNQiBJKBivsvR-erupicAwJM/edit?slide=id.g3709d9ac459_0_250#slide=id.g3709d9ac459_0_250")
```
...
```{r, fig.align='center', out.width="100%", echo = FALSE, fig.alt="Image showing the AnVIL homescreen and accessing the sign in button through the hamburger icon in the top right corner of the page."}
...
```{r, fig.align='center', out.width="100%", echo = FALSE, fig.alt= "Screenshots of signing into Terra with a Google associated account."}
