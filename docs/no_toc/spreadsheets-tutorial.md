...
<img src="spreadsheets-tutorial_files/figure-html//1ah82NLd1weER1SUEJ9aPFDWT2vLg5wK5JW6tjdVkf6o_g3b212331eba_0_11.png" alt="An example of highlighting a column with non-numerical data causing a count of filled cells to appear in the bottom right window of Google Sheets" width="100%" style="display: block; margin: auto;" />
...
<img src="spreadsheets-tutorial_files/figure-html//1ah82NLd1weER1SUEJ9aPFDWT2vLg5wK5JW6tjdVkf6o_g3b212331eba_0_16.png" alt="An example of highlighting a column with-numerical data causing various summary statistics to appear in the bottom right window of Google Sheets" width="100%" style="display: block; margin: auto;" />
...
<img src="spreadsheets-tutorial_files/figure-html//1ah82NLd1weER1SUEJ9aPFDWT2vLg5wK5JW6tjdVkf6o_g3b212331eba_0_22.png" alt="A slide detailing three ways to copy a formula to many other cells as described in the following text. An image shows method 3, where a blue dot appears on the corner of a cell and can be dragged to copy the cell's contents to other adjacent cells." width="100%" style="display: block; margin: auto;" />
