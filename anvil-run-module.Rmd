...
```{r, fig.align='center', out.width="100%", echo = FALSE, fig.alt= "An image titled Running modules on AnVIL showing a C-MOOR workspace and red boxes showing the container image and start up script lines needed to create an environment."}
