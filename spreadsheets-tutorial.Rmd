...
```{r, fig.align='center', out.width="100%", echo = FALSE, fig.alt="Right clicking on a column or row brings up a menu which allows the user to perform more functions such as by inserting/deleting columns and rows, filtering, and sorting data."}
