...
cow::borrow_chapter(
  doc_path = "docs/sciserver-about.md",
...
```{r, echo=FALSE, results='asis'}
cow::borrow_chapter(
  doc_path = "docs/sciserver-make-account.md",
  repo_name = "sayumiyork/c-moor-ottr-generic"
)
``` 
...
```{r, echo=FALSE, results='asis'}
cow::borrow_chapter(
  doc_path = "docs/sciserver-run-module.md",
  repo_name = "sayumiyork/c-moor-ottr-generic"
)
``` 
...
```{r, echo=FALSE, results='asis'}
cow::borrow_chapter(
  doc_path = "docs/anvilr-make-account.md",
  repo_name = "sayumiyork/c-moor-ottr-generic"
)
``` 
...
- [AnVIL](anvil.terra.bio)
- [SciServer](https://www.sciserver.org/)
- [Get help with technical issues on the C-MOOR Academy Discussion Forum](https://help.c-moor.org/c/help/)
