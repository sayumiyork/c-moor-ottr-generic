...
ottrpal::include_slide("https://docs.google.com/presentation/d/1dI8-_iVqbkzNMf11M4dK85E8ZW3OyZECs_YwMKw5fhs/edit#slide=id.g3636f786a65_0_249")
```
...
```{r, fig.align='center', out.width="100%", echo = FALSE, fig.alt= "Starting an RStudio environment from the workspace dashboard."}
ottrpal::include_slide("https://docs.google.com/presentation/d/1dI8-_iVqbkzNMf11M4dK85E8ZW3OyZECs_YwMKw5fhs/edit#slide=id.g37285a4c239_0_1")
```
...
```{r, fig.align='center', out.width="100%", echo = FALSE, fig.alt= "Starting an RStudio environment from the workspace dashboard."}
ottrpal::include_slide("https://docs.google.com/presentation/d/1dI8-_iVqbkzNMf11M4dK85E8ZW3OyZECs_YwMKw5fhs/edit#slide=id.g37285a4c239_0_82")
```
